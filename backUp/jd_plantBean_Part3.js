...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'qoghxsjv4y77jr3w2b65unrauu@mlrdw3aw26j3xgjmfpnlahhsxlq73adzdhcrwdq@olmijoxgmjutzfgf6tgtvyl4ghal2fvx6ocuqza@e7lhibzb3zek3fhr3d7aqesaylukj43s2plo63i@olmijoxgmjutyqyzdl6zwitxiqrl7eav5epuqly@mh5uulbrvnknknqpc2rfbgg3zwdb5xyoryws6dy@qmnmamd3ukiwqs4n2towro6igii7qq6ulvsidci',
...
!(async () => {
  ...
  for (let j = lnStartAcc; j < lnTotalAcc; j++) {
    if (cookiesArr[j]) {
      cookie = cookiesArr[j];
      $.UserName = decodeURIComponent(cookie.match(/pt_pin=([^; ]+)(?=;?)/) && cookie.match(/pt_pin=([^; ]+)(?=;?)/)[1])
      $.index = j + 1;
